  ...
  return {
    ...
    verdict: {
      ...
      reason: paid > 0
        ...
        : 'Le lancement est autorisé. Un témoin Odoo VPS est reçu mais classé en indésirables ; Facebook exige une reconnexion dans Postiz, donc Make et Odoo SaaS restent les replis actifs.',
    },
    kpis: {
    ...
    channels: {
      ...
      email: {
        ...
        vps: {
          ...
          linkedMailings: 0,
          reason: 'Un témoin est reçu dans Gmail, mais classé en indésirables. Les 9 prospects restent isolés et bloqués jusqu’à qualification.',
        },
      },
    ...
    internalEngines: {
      ...
      services: [
        ...
        },
        {
          ...
          observed: 'Trois brouillons utilisent le SMTP ArbitragePro dédié. Un témoin est reçu dans Gmail mais classé en indésirables. 9 vendeurs US/Europe sont isolés, tous bloqués jusqu’à qualification, sans campagne ni automatisation contact.',
          proof: 'VÉRIFIÉ',
