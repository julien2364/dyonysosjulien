...
const PROJECTS = [
  ...
  { name: 'Propecto', categorie: 'Annuaire entreprises C2B/B2B', url: 'https://www.propecto.eu/', github: 'julien2364/annuaire', drive: 'Prospeo - Livrables (Claude), Projet 2 - Annuaire entreprises et vente de leads, Propecto, Propecto — Communication omnicanale 3 mois, Propecto — vidéos à juger', local: null, vercelProjectId: 'prj_iTUKEu3BUVEGJpxm9nS0Km7vjIUs', priorite: 'normal', etat: 'Délégué à ChatGPT/Codex depuis le 17/08 — Claude assure uniquement la communication/relève horaire, plus aucun développement direct. 0 visiteur mesuré sur 30j.', taches: ['Relève horaire de ce que Codex a laissé, instructions suivantes, vérification', 'Construire le C2B en premier (gratuit, priorité posée)', 'Grille B2B (France 29€, Team ×2,5, Corporate sur devis)'], note: 'Fusionné le 24/08 : "Propecto (annuaire)" était le même projet renommé, doublon supprimé du registre (une seule entrée maintenant). Vercel: prospeo, prospeo-prototype, prospeo-mvp, firmoscope-design, firmoscope-site — plusieurs projets Vercel pour la même famille, à consolider.',
    suivi: {
      ...
      flags: [ { tag: 'À noter — coordination', texte: 'Le commit e69dff7 (renommage Propecto→Propecto sur 55 articles, 15h23 UTC) vient d’un troisième agent — ni Codex, ni cette session Claude. Le modèle de coordination du projet suppose deux écrivains (Claude + Codex, CLAUDE.md §5) ; un troisième compte actif explique une partie des verrous git rencontrés. À clarifier avec Julien : qui est ce compte, et faut-il l’intégrer au journal partagé.' } ],
      enCours: [
      ...
      livreAujourdhui: [
        ...
        { heure: '18h08', titre: 'Résidu « Propecto »', detail: 'sur le tag de 3 articles — donnée, pas code. Corrigé, vérifié en direct.', commit: '72d5aa0' },
  ...
  { name: 'Arbitrage+', categorie: 'Commerce et performance', url: 'https://www.arbitragepro.eu', github: 'julien2364/Arbitrage', drive: 'Arbitrage-Pro', local: null, vercelProjectId: 'prj_YNDpcwcBx3TfwNUF3TFDpTF6U8YJ', priorite: 'normal', etat: 'Keepa API souscrite (Starter, 49€/mois) + accès SP-API demandé — sources réelles en cours de branchement. Web Analytics non actif (0 mesuré).', taches: ['Réconcilier arb-app vs arbitrage-pro (version déployée = build minimale, version complète non déployée)', 'Retirer les données simulées, brancher les vraies API/catalogues (Eany.io 849k lignes, Qogita 414k lignes)', 'Focus sur l’extension Chrome', 'Stripe en dernière étape (ordre imposé par Julien)'] },
  { name: 'Analyzer+', categorie: 'Commerce et performance', url: 'https://www.analyzer-plus.eu', github: 'julien2364/analyzer', drive: null, local: null, vercelProjectId: 'prj_B1jt5DLJiQ9wqKiP0UJz2V0kU4rG', priorite: 'normal', etat: 'P0 fait : auth réelle Supabase + persistance favoris/notes. 49 visiteurs / 30j.', taches: ['Câbler l’historique ap_history', 'Passer aux vraies données marché (Keepa/SP-API) au lieu de démo'] },
  { name: 'Profit+', categorie: 'Commerce et performance', url: 'https://www.profit-plus.tech', github: 'julien2364/profit', drive: null, local: null, vercelProjectId: 'prj_hTcxKWwRPCATVgMAiEDlrh2hev6Q', priorite: 'normal', etat: 'P0 répliqué : auth réelle + watchlist par utilisateur. 30 visiteurs / 30j.', taches: ['Brancher SP-API réelle', 'Viser la parité 100% Sellerboard + nouvelles features'] },
  ...
  // --- Création et médias ---
  { name: 'Linktrib', categorie: 'Création et médias', url: 'https://www.linktrib.com', github: 'julien2364/Kreo', drive: 'kreo', local: '/Users/juliendaures/kreo (non connecté à cette session)', vercelProjectId: 'prj_wMSAHpc5ISZm0H0QVkCfdsjkih92', note: 'Kreo est le nom technique du dépôt ; Linktrib est le produit public.' },
  { name: 'Agoeon', categorie: 'Création et médias', url: 'https://www.agoeon.com', github: 'julien2364/remake-patreon-082026', drive: null, local: null, vercelProjectId: 'prj_1SY0dtoQNJWuUKynv9Wvm12z8iaX', note: 'Produit public distinct de Linktrib.' },
  { name: 'Etsy · PetStoneOriginal', categorie: 'Marketplaces personnels', url: 'https://www.etsy.com/shop/PetStoneOriginal', github: null, drive: null, local: null, priorite: 'urgent', etat: 'Boutique déclarée active ; snapshot 08/09 : 114 visites / 7 jours, 0 commande. API Etsy non configurée.', taches: ['Exporter Etsy Payments', 'Calculer marge et attribution des 10 fiches les plus vues'], note: 'Les 9 ventes historiques ne sont pas un revenu actuel tant que payout, frais, remboursements et COGS ne sont pas rapprochés.' },
