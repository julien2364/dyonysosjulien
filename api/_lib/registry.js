...
const PROJECTS = [
  ...
  { name: 'Firmoscope / Prospeo (ex-Propecto)', categorie: 'Annuaire entreprises C2B/B2B', url: 'https://prospeo-drab.vercel.app/', github: 'julien2364/annuaire', drive: 'Prospeo - Livrables (Claude), Projet 2 - Annuaire entreprises et vente de leads, Propecto, Propecto — Communication omnicanale 3 mois, Propecto — vidéos à juger', local: null, vercelProjectId: 'prj_iTUKEu3BUVEGJpxm9nS0Km7vjIUs', priorite: 'normal', etat: 'Délégué à ChatGPT/Codex depuis le 17/08 — Claude assure uniquement la communication/relève horaire, plus aucun développement direct. 0 visiteur mesuré sur 30j.', taches: ['Relève horaire de ce que Codex a laissé, instructions suivantes, vérification', 'Construire le C2B en premier (gratuit, priorité posée)', 'Grille B2B (France 29€, Team ×2,5, Corporate sur devis)'], note: 'Fusionné le 24/08 : "Propecto (annuaire)" était le même projet renommé, doublon supprimé du registre (une seule entrée maintenant). Vercel: prospeo, prospeo-prototype, prospeo-mvp, firmoscope-design, firmoscope-site — plusieurs projets Vercel pour la même famille, à consolider.',
    suivi: {
