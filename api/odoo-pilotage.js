...
async function getPayload() {
  ...
  return {
    ...
    videoPlan: [
      { product: 'Amazon + Packlink — EN', priority: 1, demoReady: true, screenshots: true, script: true, video: true, youtube: true, listingLinked: true },
      { product: 'MRP Essentiel — EN', priority: 2, demoReady: true, screenshots: true, script: true, video: true, youtube: true, listingLinked: true },
      { product: 'Amazon + Packlink — FR (autorisation chaîne à corriger)', priority: 3, demoReady: true, screenshots: true, script: true, video: true, youtube: false, listingLinked: false },
      { product: 'MRP Essentiel — FR (autorisation chaîne à corriger)', priority: 4, demoReady: true, screenshots: true, script: true, video: true, youtube: false, listingLinked: false },
      { product: 'MCP Server for Odoo', priority: 5, demoReady: false, screenshots: false, script: false, video: false, youtube: false, listingLinked: false },
    ],
  };
}
