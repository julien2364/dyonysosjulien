...
module.exports = async function handler(req, res) {
  ...
  if (sheetsConfigure) {
    ...
    // en dehors de lui (Propecto/Prospeo ex-Propecto, Pet Stone, CVDesignPro). Lus ici en direct
  ...
  if (isMakeConfigured()) {
    ...
    makeSnapshot = {
      ...
      scenarios: [
        { nom: 'Propecto Social net', statut: 'ACTIF — planifié', statutCode: 'ok', source: 'Data Store Make (calendrier Propecto/Prospeo)', apps: ['Facebook', 'LinkedIn', 'Instagram', 'YouTube'], relais: 'Actif et planifié au dernier contrôle ; résultat de la prochaine publication à contrôler dans l’historique Make.', detail: 'Scénario principal actif, avec deux scénarios actifs complémentaires pour l’injection et la boucle du calendrier. Aucun brouillon ou publication n’a été déclenché depuis ce tableau.' },
